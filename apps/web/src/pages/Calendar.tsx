...
export const Calendar: React.FC = () => {
  ...
  return (
    <div className="space-y-6">
      <div className="overflow-hidden rounded-[32px] border border-app-border bg-[radial-gradient(circle_at_top_left,#ffffff_0%,#f7fbff_38%,#edf5fb_100%)] shadow-panel">
        <div className="flex flex-col gap-5 p-6 lg:flex-row lg:items-center lg:justify-between">
          <div>
            ...
            <h2 className="mt-4 text-2xl font-extrabold text-app-text">Calendario</h2>
          ...
          <div className="flex flex-col items-start gap-3 sm:flex-row sm:items-center">
            ...
            <button
              ...
              className="inline-flex items-center gap-2 rounded-2xl bg-app-info px-5 py-3 text-sm font-bold text-white shadow-[0_18px_40px_rgba(57,175,209,0.22)] transition hover:-translate-y-0.5 hover:brightness-95 disabled:translate-y-0 disabled:cursor-not-allowed disabled:opacity-60"
            >
      ...
      {syncMessage ? (
        <div className="rounded-2xl border border-app-border bg-app-surface px-4 py-3 text-sm text-slate-600 shadow-panel">
          {syncMessage}
        </div>
      ) : null}
