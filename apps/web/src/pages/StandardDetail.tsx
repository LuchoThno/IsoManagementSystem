          ...
          <button
            ...
            className={`w-full rounded-2xl border px-4 py-3 text-left transition ${
              selectedRequirementId === requirement.id
                ...
                : 'border-slate-200 bg-app-surface-alt hover:bg-slate-100'
            }`}
          >
    ...
    <div className="space-y-6">
      <section className="panel-card p-6">
        <div className="flex flex-col gap-4 lg:flex-row lg:items-start lg:justify-between">
          <div>
            ...
            <h1 className="mt-2 text-3xl font-extrabold text-app-text">
          ...
          <div className="app-subtle-card"><p className="text-xs font-bold uppercase text-slate-400">Secciones</p><p className="mt-2 text-2xl font-extrabold text-app-text">{structure.sections.length}</p></div>
          <div className="app-subtle-card"><p className="text-xs font-bold uppercase text-slate-400">Cláusulas</p><p className="mt-2 text-2xl font-extrabold text-app-text">{structure.metrics.totalClauses}</p></div>
          <div className="app-subtle-card"><p className="text-xs font-bold uppercase text-slate-400">Requisitos</p><p className="mt-2 text-2xl font-extrabold text-app-text">{structure.metrics.totalRequirements}</p></div>
          <div className="app-subtle-card"><p className="text-xs font-bold uppercase text-slate-400">Cumplimiento</p><p className="mt-2 text-2xl font-extrabold text-app-text">{structure.metrics.complianceRate}%</p></div>
        </div>
      </section>
      ...
      {isEditing ? (
        <section className="panel-card p-6">
          ...
          <div className="mt-6 flex flex-wrap gap-3">
            <button
              ...
              className="app-button-primary px-5 py-3 disabled:opacity-70"
            >
        ...
        <div className="grid gap-6 xl:grid-cols-[1.15fr_0.85fr]">
          <section className="panel-card p-6">
            <h2 className="text-xl font-extrabold text-app-text">Cláusulas y requisitos</h2>
            <div className="mt-5 space-y-5">
              {structure.sections.map((section) => (
                <article key={section.id} className="rounded-[24px] border border-slate-200 bg-app-surface-alt/70 p-5">
                  <div>
                    <p className="text-xs font-bold uppercase tracking-[0.18em] text-slate-400">
                      {section.code}
                    </p>
                    <h3 className="mt-2 text-lg font-extrabold text-app-text">{section.title}</h3>
          ...
          <section className="space-y-6">
            <div className="panel-card p-6">
              <h2 className="text-xl font-extrabold text-app-text">Evidencia objetiva</h2>
              {selectedRequirement ? (
                <>
                  ...
                  <div className="mt-5 space-y-3">
                    {evidences.map((evidence) => (
                      <article key={evidence.id} className="rounded-2xl border border-slate-200 bg-app-surface-alt p-4">
                        <div className="flex items-center justify-between gap-3">
                          <p className="font-bold text-app-text">{evidence.title}</p>
            ...
            {selectedRequirement && (
              ...
              >
                <h3 className="text-lg font-extrabold text-app-text">Agregar evidencia</h3>
                <div className="mt-4 space-y-3">
                  ...
                  <button type="submit" disabled={createEvidenceMutation.isPending} className="app-button-primary w-full disabled:opacity-70">
